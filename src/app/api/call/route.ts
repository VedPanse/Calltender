...
export async function POST(req: Request) {
  try {
    ...
    console.log("Call request:", { to, from: from ? "***SET***" : "MISSING", url });
    ...
    if (!from) {
      return NextResponse.json(
        { sid: null, status: "missing-source", error: "Missing Twilio phone number. Please set TWILIO_FROM_NUMBER in your environment variables or get a Twilio phone number from https://console.twilio.com/" },
        { status: 400 }
      );
    }
